...
一款为 [AstrBot](https://astrbot.app) 设计的图床插件。它能从 [CloudFlare-ImgBed 图床](https://github.com/MarSeventh/CloudFlare-ImgBed) 获取随机图片/视频，并支持上传图片/视频到图床。还提供关键词映射功能，可自定义指令获取特定文件夹内容。
